<?php
$input=array("1)what is the full form of php" =>array("Personal Homepage","Preprocessor Homepage"),"2)Who is the father of php?"=>array("Rasmus Lerdorf","Dennis M Ritchie"));
//print_r($input)
//print_r($input);
//exit();
